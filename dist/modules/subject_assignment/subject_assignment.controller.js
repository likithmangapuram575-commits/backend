...
const subAssignService = __importStar(require("./subject_assignment.service"));
...
const getAssignments = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const assignments = yield subAssignService.getAssignmentsByDepartment(hod.department_id);
...
const createAssignment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield subAssignService.addAssignment(req.body);
...
const deleteAssignment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield subAssignService.deleteAssignment(Number(id));
